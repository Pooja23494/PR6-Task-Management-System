                    ...
                    <div className="navbar-content">
                        <ul className="nxl-navbar">
                            ...
                            <li className="nxl-item nxl-hasmenu">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="reports-sales.html">Sales Report</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="reports-leads.html">Leads Report</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="reports-project.html">Project Report</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="reports-timesheets.html">Timesheets Report</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="apps-chat.html">Chat</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="apps-email.html">Email</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="/appsTasks">Tasks</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="apps-notes.html">Notes</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="apps-storage.html">Storage</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="apps-calendar.html">Calendar</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="proposal.html">Proposal</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="proposal-view.html">Proposal View</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="proposal-edit.html">Proposal Edit</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="proposal-create.html">Proposal Create</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="payment.html">Payment</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="invoice-view.html">Invoice View</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="invoice-create.html">Invoice Create</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="customers.html">Customers</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="customers-view.html">Customers View</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="customers-create.html">Customers Create</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="leads.html">Leads</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="leads-view.html">Leads View</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="leads-create.html">Leads Create</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="projects.html">Projects</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="projects-view.html">Projects View</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="projects-create.html">Projects Create</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="widgets-lists.html">Lists</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="/widgetsTables">Tables</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="widgets-charts.html">Charts</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="widgets-statistics.html">Statistics</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="widgets-miscellaneous.html">Miscellaneous</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-general.html">General</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-seo.html">SEO</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-tags.html">Tags</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-email.html">Email</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-tasks.html">Tasks</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-leads.html">Leads</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-support.html">Support</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-finance.html">Finance</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-gateways.html">Gateways</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-customers.html">Customers</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-localization.html">Localization</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-recaptcha.html">reCAPTCHA</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="settings-miscellaneous.html">Miscellaneous</Link></li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                <Link to="javascript:void(0);" className="nxl-link">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item nxl-hasmenu">
                                        ...
                                        <ul className="nxl-submenu">
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-login-cover.html">Cover</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-login-minimal.html">Minimal</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-login-creative.html">Creative</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nxl-item nxl-hasmenu">
                                        <Link to="javascript:void(0);" className="nxl-link">
                                        ...
                                        <ul className="nxl-submenu">
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-register-cover.html">Cover</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-register-minimal.html">Minimal</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-register-creative.html">Creative</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nxl-item nxl-hasmenu">
                                        <Link to="javascript:void(0);" className="nxl-link">
                                        ...
                                        <ul className="nxl-submenu">
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-404-cover.html">Cover</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-404-minimal.html">Minimal</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-404-creative.html">Creative</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nxl-item nxl-hasmenu">
                                        <Link to="javascript:void(0);" className="nxl-link">
                                        ...
                                        <ul className="nxl-submenu">
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-reset-cover.html">Cover</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-reset-minimal.html">Minimal</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-reset-creative.html">Creative</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nxl-item nxl-hasmenu">
                                        <Link to="javascript:void(0);" className="nxl-link">
                                        ...
                                        <ul className="nxl-submenu">
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-verify-cover.html">Cover</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-verify-minimal.html">Minimal</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-verify-creative.html">Creative</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nxl-item nxl-hasmenu">
                                        <Link to="javascript:void(0);" className="nxl-link">
                                        ...
                                        <ul className="nxl-submenu">
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-maintenance-cover.html">Cover</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-maintenance-minimal.html">Minimal</Link></li>
                                            <li className="nxl-item"><Link className="nxl-link" to="./auth-maintenance-creative.html">Creative</Link></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li className="nxl-item nxl-hasmenu">
                                ...
                                <ul className="nxl-submenu">
                                    <li className="nxl-item"><Link className="nxl-link" to="#!">Support</Link></li>
                                    <li className="nxl-item"><Link className="nxl-link" to="help-knowledgebase.html">KnowledgeBase</Link></li>
                        ...
                        <div className="card text-center">
                            <div className="card-body">
                                ...
                                <Link to="https://www.themewagon.com/themes/Duralux-admin" target="_blank" className="btn btn-primary text-dark w-100">Download Now</Link>
                            </div>
                        </div>
                    </div>
                </div>
