                            ...
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <div className="mb-4">
                                        ...
                                        <input type="text" id="taskName" name='taskName' onChange={handleChange} value={task.taskName || ''} className="form-control" placeholder="Task Name" />
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="editor">
                                            <div className="ht-150" id="notesEditorAdd">
                                                <textarea className='form-control' rows={6} name='description' onChange={handleChange} value={task.description || ''}></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div id="taskDateRangeAdd" className="mb-4">
                                        ...
                                        <div className="input-group date input-daterange">
                                            <input type="date" name="rangeStart" onChange={handleChange} value={task.rangeStart || ''} className="form-control" placeholder="Start date..." autoComplete="off" />
                                            <span className="input-group-text">to</span>
                                            <input type="date" name="rangeEnd" onChange={handleChange} value={task.rangeEnd || ''} className="form-control" placeholder="End date..." autoComplete="off" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group mb-4">
                                        ...
                                        <select className="form-select form-control" name="priority" onChange={handleChange} value={task.priority || ''} data-select2-selector="priority">
                                    ...
                                    <div className="form-group mb-0">
                                        ...
                                        <select className="form-select form-control" name="tag" onChange={handleChange} value={task.tag || ''} data-select2-selector="tag">
